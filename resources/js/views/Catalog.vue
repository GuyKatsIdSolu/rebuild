    ...
    <div class="shop-gallery-page shop">
      <div class="categories-filter">
        ...
        <a v-for="(categoryId,index) in categories" :key="categoryId" href="" @click.prevent="$router.push('/@'+img.creator.username+'-'+categoryId)">
          <div class="item">
            <img :src="'/storage/images/nav_icons/'+productsBycategory[categoryId][Object.keys(productsBycategory[categoryId])[0]].details.category.name+'.png'"/>
            <div>
      ...
      <div class="container no-padding">
        <div class="">
          <div class="row user-header-info">
            <div class="avatar">
              <img  :src="'/storage/creator_images/'+ img.creator_id+'.jpg'" alt="Avatar of creator">
            </div>
            <div class="right">
                ...
                <div v-for="(product,index) in products" :key="index" class="col-xs-6 col-md-3 gallery-item " style="  ">
                  ...
                  <a href="" @click.prevent="$router.push('/product-' + product.id)" >
                    <div class="gallery-item-frame">
                      ...
                      <v-lazy-image class="prev-gallery-img" :src="'/storage/creator_images/'+img.id+'/previews/'+product.product_code+'/1000_1.jpg'" src-placeholder="/storage/images/placeholder-white.png" />
                    </div>
