<template>
<modal class="edit-modal" name="EditModal" width="860px" height="710px" :scrollable="true" :reset="true" @before-open="beforeOpen" @opened="afterOpen" @before-close="beforeClose">
  <div class="container edit-image-popup">
    <a class="close" @click="$modal.hide('EditModal')">
    ...
    <div class="col-md-12 row-1">
      <h2 v-if="$root.isMobile" class="title">
        Edit image <span class="id">ID ({{img.id}})</span>
      </h2>
      <h2 v-else class="title">
        Image ID {{img.id}}
      </h2>
      <div class="trash" @click="deleteImg()" v-if="!$root.isMobile">
        <i class="fas fa-trash">
        </i>
        Delete Image
      </div>
    </div>
    <div class="products-box" v-if="showProducts">
      <div class="row-two">
            ...
            <slide v-for="(product ,index) in products" :key="index">
              <div class="row cur-box" :data-pid="index">
                ...
                <div class="col-md-6 details">
                  <div class="title">{{product.details.title}}</div>
                  <div class="desc" v-html="product.details.html_description"></div>
                  <div class="col-xs-12 prices" style="margin-top: 10px;">
                    <div class="price">$<span class="inpt">{{prices[product.product_code]}}</span></div>
                    <div class="dis-price">$<span class="inpt">{{(prices[product.product_code]*(100-creator.discount)/100).toFixed(2)}}</span></div>
                  </div>
                  <div class="prices-page-box">
                    To edit shop products and set products prices please visit <a href="/store-settings" @click="$ma.trackEvent({action: 'account-page',properties: {feature: 'edit button',type: 'store-settings-button-clicked'}});" style="    color: #C000FF;">Store settings page</a>
                  </div>
                </div>
              </div>
            </slide>
            <hooper-navigation v-if="$root.isMobile" slot="hooper-addons">
              <svg slot="hooper-next" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg">
                <path
              ...
              <svg slot="hooper-prev" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg">
                <path d="M729.6 931.2l-416-425.6 416-416c9.6-9.6 9.6-25.6 0-35.2-9.6-9.6-25.6-9.6-35.2 0l-432 435.2c-9.6 9.6-9.6 25.6 0 35.2l432 441.6c9.6 9.6 25.6 9.6 35.2 0C739.2 956.8 739.2 940.8 729.6 931.2z" /></svg>
            </hooper-navigation>
          </hooper>
        </div>
    ...
    <div class="col-md-12" style="float: right;">
      <ul v-if="!$root.isMobile" class="tabs nav nav-tabs">
        <li class="">
          <a class="active" href="#details" data-toggle="tab" aria-expanded="false" @click="showProducts=false">
            Details
          </a>
        </li>
        <!-- <li class="">
            <a class="" href="#share" data-toggle="tab" aria-expanded="false" @click="showProducts=false">
              Share
            </a>
          </li> -->
        <li class="">
          <a class="" href="#products" data-toggle="tab" aria-expanded="false" @click="showProducts=true">
            Products
          </a>
        </li>
      </ul>
      <div class="tab-content tab-content--padded edit-photo__tab-content">
        <div class="tab-pane active" id="details">
          ...
          <div class="col-md-6 det">
            <div class="input">
              ...
              <input class="margin-bottom-6" v-model="name" maxlength="25" />
            </div>
            <div class="input">
              <div class="margin-bottom-6">
                <b>Image Description</b><span class="grey"> (Optional)</span>
              </div>
              <textarea maxlength="140" class="margin-bottom-6" v-model="description" />
              </div>
            <div class="input">
              <div class="margin-bottom-6">
                <b>Tag Words</b><span class="grey"> (Auto Generated)</span>
              </div>
              <div class="col-md-12">
                <div class="tags-box">
                  <label for="tags">Please add tags to your image (separated by Enter or Comma)</label>
                  <input class="tags-input" style="    width: 100px;" @keyup="addTag($event)" placeholder="Add tag" /><br>
                  <div class="tag" v-for="(imgTag, j) in tags" :key="j">
                    <span @click="deleteTag($event)"><i class="fa fa-times"></i></span>
          ...
          <a @click="update" style="" class="update-btn">Update</a>
        </div>
        <div class="tab-pane" id="share">
          <div class="col-md-6" v-if="!$root.isMobile">
            <div class="socail-img-box">
              <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 600 500" style="enable-background:new 0 0 600 500;" xml:space="preserve">
                <path class="st0" d="M342.5,103.6c-36.4-1.3-71-13-104.1-25.9S172.5,50.7,137,43.9c-22.8-4.4-48.9-5-67.3,7.2
                ...
                <g class="st1">
                  <path class="st2" d="M381.2,180.8h2.4c0.7,0,1.3,0.6,1.3,1.3v38.5c0,0.7-0.6,1.3-1.3,1.3h-2.4c-0.7,0-1.3-0.6-1.3-1.3v-38.5
                    C379.9,181.4,380.4,180.8,381.2,180.8z" />
                  <path class="st2" d="M215.7,148.7h0.2c0.7,0,1.3,0.6,1.3,1.3v10.9c0,0.7-0.6,1.3-1.3,1.3h-0.2c-0.7,0-1.3-0.6-1.3-1.3V150
                    C214.4,149.2,215,148.7,215.7,148.7z" />
                  <path class="st2" d="M215.6,173.4h0.6c0.7,0,1.3,0.6,1.3,1.3v20.9c0,0.7-0.6,1.3-1.3,1.3h-0.6c-0.7,0-1.3-0.6-1.3-1.3v-20.9
                    C214.3,174,214.9,173.4,215.6,173.4z" />
                  <path class="st2" d="M215.6,205.1h0.4c0.7,0,1.3,0.6,1.3,1.3v21.1c0,0.7-0.6,1.3-1.3,1.3h-0.4c-0.7,0-1.3-0.6-1.3-1.3v-21.1
                    C214.3,205.7,214.9,205.1,215.6,205.1z" />
                  <path class="st2" d="M237.9,104h122.8c12.1,0,21.9,9.8,21.9,21.9v294.7c0,12.1-9.8,21.9-21.9,21.9H237.9
                    c-12.1,0-21.9-9.8-21.9-21.9V125.9C216,113.8,225.8,104,237.9,104z" />
                  <path class="st3" d="M285.4,114.1h18.9c1.2,0,2.2,1,2.2,2.2v0.4c0,1.2-1,2.2-2.2,2.2h-18.9c-1.2,0-2.2-1-2.2-2.2v-0.4
                    C283.2,115.1,284.2,114.1,285.4,114.1z" />
                  <circle class="st3" cx="312.7" cy="116.5" r="2.7" />
                </g>
                <ellipse class="st0" cx="115.6" cy="450.4" rx="112.4" ry="11.5" />
                <ellipse class="st0" cx="365.5" cy="488.6" rx="52.6" ry="5.4" />
                <ellipse class="st0" cx="545.4" cy="461.6" rx="52.6" ry="5.4" />
                <path class="st4" d="M359,112.8H340v2.3c0,6-4.9,10.9-10.9,10.9l0,0h-60.8c-6,0-10.9-4.9-10.9-10.9c0,0,0,0,0,0v-2.3h-17.9
                ...
                <rect x="310.3" y="315.2" class="st5" width="43.9" height="43.9" />
                <rect x="245.7" y="257.3" class="st5" width="43.9" height="43.9" />
                <rect x="249.9" y="372.1" class="st5" width="43.9" height="43.9" />
                <rect x="240.1" y="149.6" class="st6" width="43.9" height="43.9" />
                <rect x="321.9" y="308.4" transform="matrix(0.7415 -0.6709 0.6709 0.7415 -132.7786 316.0672)" class="st6" width="43.9" height="43.9" />
                <rect x="309.6" y="202.5" class="st6" width="43.9" height="43.9" />
                <rect x="254.1" y="251.4" class="st6" width="43.9" height="43.9" />
                <path class="st7" d="M548,366.2" />
                <rect x="418.1" y="152" class="st8" width="76.8" height="76.8" />
                <rect x="93.6" y="268.7" class="st8" width="81.6" height="81.6" />
                <path class="st4" d="M344.7,216.5c-0.9,0.4-1.9,0.7-2.9,0.8c1.1-0.6,1.9-1.6,2.2-2.8c-1,0.6-2.1,1-3.2,1.2c-1.9-2.1-5.1-2.2-7.2-0.3
                ...
                <path class="st4" d="M326.1,326.5l1.7,4.2l11,11.7l3.7-3.5l2.3,2.5l2.5-2.3l0.1-4.8l3.1-2.9l0.2-8.4l-9.9-10.4L326.1,326.5z
                  M348.3,324.2l-0.1,4.8l-3.7,3.5l-0.1,4.8l-2.3-2.5l-3.1,2.9l-9.9-10.4l11.7-11L348.3,324.2z" />
                <path class="st4" d="M339.4,322.1l1.8-1.7l4.7,5l-1.8,1.7L339.4,322.1z M335.1,326.2l1.8-1.7l4.7,5l-1.8,1.7L335.1,326.2z" />
                <path class="st4" d="M158.8,284.1h-44.5c-1.5,0-2.8,1.2-2.8,2.8v44.6c0,1.5,1.2,2.8,2.8,2.8h22.2v-19.8h-6v-7.3h6.1v-5.4
                ...
                <path class="st4" d="M280,264.7c2.3,0,4.2,1.9,4.2,4.2v8.4c0,2.3-1.9,4.2-4.2,4.2h-8.4c-1.1,0-2.2-0.4-3-1.2c-0.8-0.8-1.2-1.9-1.2-3
                ...
                <path class="st4" d="M281.3,268.9c-0.7,0-1.3-0.6-1.3-1.3c0-0.7,0.6-1.3,1.3-1.3c0.7,0,1.3,0.6,1.3,1.3c0,0,0,0,0,0
                ...
                <path class="st4" d="M481.2,180.2c0-4.2-3.1-7.5-6.9-7.5c-5.1-0.2-10.3-0.3-15.7-0.3h-1.7c-5.3,0-10.6,0.1-15.7,0.3
                ...
                <path class="st4" d="M261.8,159.6c-6.5-0.1-11.8,5.2-11.9,11.7c0,4.8,2.8,9.1,7.2,11c-0.1-0.9,0-1.8,0.2-2.7c0.2-1,1.5-6.4,1.5-6.4
                ...
                <path class="st9" d="M358.6,481.4c0.3,0.3,0.5,0.6,0.6,0.9l0,0l-8,0.9c0.4-0.6,0.6-1.2,0.6-1.9C351.8,481.4,357.1,479.8,358.6,481.4
                  z" />
                <path class="st10" d="M367,438l8.9-1.2C375.9,436.8,370.9,442,367,438z" />
                <path class="st9" d="M374.6,428.1c0,0,0.3,3.1-1.6,4.3C373,432.5,376.4,431.9,374.6,428.1z" />
                <path class="st9" d="M356,440.9c0,0-5.6,1.3-5.8,3.6C350,446.7,356,440.9,356,440.9z" />
                <path class="st9" d="M316.3,333.4l-4,2.1l-0.4-0.8c0.6-0.5,2.5-2.1,3.2-2c0.3,0,0.6,0,0.9,0C316.2,333.1,316.3,333.4,316.3,333.4z" />
                <path class="st9" d="M330.9,347.3c-0.1,0.7-6.1,1.3-6.1,1.3l3-3.1l0,0l0.1,0l0,0C329,346,330,346.6,330.9,347.3z" />
                <circle class="st11" cx="379.3" cy="341.2" r="0.4" />
                <circle class="st11" cx="379.4" cy="342.2" r="0.4" />
                <circle class="st11" cx="379.4" cy="343.2" r="0.4" />
                <path class="st9" d="M335.4,350.9c0-0.1-1.4,5.2,5.1,8.1C340.5,359,337.8,358.1,335.4,350.9z" />
                <path class="st9" d="M375.3,346.5c-0.1,0,3.2,2.1,4,3C379.3,349.5,377.2,346.3,375.3,346.5z" />
                <path class="st9" d="M353.2,346.8c0,0,10.1,1.3,11-0.2" />
                <path class="st9" d="M372.7,342.6c0,0,5.6,0,6.8,2.1" />
              </svg>
            </div>
          </div>
          <div class="col-md-6 row-2">
            <div class="form-group">
              <div class="">
                <label>Image store link-</label>
                <div class="cpy-lnk">
                  <input class="store-link" value="">
            ...
            <div class="socail-icons-box">
              <a href="#">
                <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  <title>A8ECCCFC-043E-4C8E-B8E7-ACA635A18055</title>
                  <desc>Created with sketchtool.</desc>
                  <g id="Page-3" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    <g id="aaa" transform="translate(-236.000000, -407.000000)" fill-rule="nonzero">
              ...
              <a href="#"><svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  <title>DC0455CB-8FE9-4E25-BB03-4685F2C9B120</title>
                  <desc>Created with sketchtool.</desc>
                  <g id="Page-3" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    <g id="public-gallery" transform="translate(-332.000000, -407.000000)" fill="#000000" fill-rule="nonzero">
                      <g id="Group-5" transform="translate(80.000000, 339.000000)">
                        <g id="Stacked-Group-3" transform="translate(124.000000, 68.000000)">
                          <g id="instagram" transform="translate(128.000000, 0.000000)">
                            <path
                              d="M15.5346667,6.368 L8.4008,6.368 C7.26213333,6.368 6.33573333,7.2944 6.33573333,8.43306667 L6.33573333,15.5669333 C6.33573333,16.7056 7.26213333,17.6322667 8.4008,17.6322667 L15.5346667,17.6322667 C16.6733333,17.6322667 17.6,16.7058667 17.6,15.5669333 L17.6,8.43306667 C17.6,7.2944 16.6736,6.368 15.5346667,6.368 Z M11.9677333,15.7082667 C9.9232,15.7082667 8.25973333,14.0448 8.25973333,12 C8.25973333,9.95546667 9.9232,8.292 11.9677333,8.292 C14.0125333,8.292 15.676,9.95546667 15.676,12 C15.676,14.0445333 14.0122667,15.7082667 11.9677333,15.7082667 Z M15.7952,9.05866667 C15.3112,9.05866667 14.9176,8.66506667 14.9176,8.18133333 C14.9176,7.6976 15.3112,7.304 15.7952,7.304 C16.2789333,7.304 16.6725333,7.6976 16.6725333,8.18133333 C16.6725333,8.66506667 16.2789333,9.05866667 15.7952,9.05866667 Z"
                              id="Shape"></path>
                            <path
                              d="M11.9677333,9.85893333 C10.7874667,9.85893333 9.8264,10.8194667 9.8264,11.9997333 C9.8264,13.1805333 10.7874667,14.1413333 11.9677333,14.1413333 C13.1485333,14.1413333 14.1088,13.1805333 14.1088,11.9997333 C14.1088,10.8197333 13.1482667,9.85893333 11.9677333,9.85893333 Z"
                              id="Path"></path>
                            <path
              ...
              <a href="#"><svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  <title>1661BD68-5C07-47BF-BF96-117C8D83D485</title>
                  <desc>Created with sketchtool.</desc>
                  <g id="Page-3" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    <g id="hhh" transform="translate(-268.000000, -407.000000)" fill-rule="nonzero">
                      <g id="Group-5" transform="translate(80.000000, 339.000000)">
                        <g id="Stacked-Group-3" transform="translate(124.000000, 68.000000)">
                          <g id="pinterest" transform="translate(64.000000, 0.000000)">
                            <circle id="Oval" fill="#000000" cx="11.9148319" cy="11.9150442" r="11.9146195"></circle>
                            <path
              ...
              <a href="#"><svg width="24px" height="25px" viewBox="0 0 24 25" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  <title>reddit</title>
                  <desc>Created with Sketch.</desc>
                  <g id="Page-3" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    <g id="reddit" transform="translate(0.000000, 0.000000)" fill-rule="nonzero">
                      <path
                        d="M14.5888244,16.7134289 C14.034619,17.1744577 12.8471169,17.3390212 12.0008966,17.3390212 C11.1522224,17.3390212 9.9671743,17.1744577 9.41296892,16.7134289 C9.28177928,16.6042956 9.07149838,16.6042956 8.94049749,16.7134289 C8.80930785,16.8225621 8.80930785,16.9974892 8.94049749,17.1064654 C9.8188073,17.8371082 11.5061513,17.8947368 12.0008966,17.8947368 C12.4956419,17.8947368 14.180532,17.8371082 15.0614845,17.1064654 C15.1900315,16.9973322 15.1900315,16.822405 15.0614845,16.7134289 C14.9302949,16.6042956 14.7200139,16.6042956 14.5888244,16.7134289 L14.5888244,16.7134289 Z"
                        id="Path" fill="#000000"></path>
                      <path
                        d="M10.5263158,13.6842105 C10.5263158,12.9883546 9.95901379,12.4210526 9.26315789,12.4210526 C8.56748691,12.4210526 8,12.9883546 8,13.6842105 C8,14.3798815 8.56748691,14.9473684 9.26315789,14.9473684 C9.95901379,14.9473684 10.5263158,14.3800665 10.5263158,13.6842105 L10.5263158,13.6842105 Z"
                        id="Path" fill="#000000"></path>
                      <path
                      ...
                      <path
                        d="M14.7368421,12.4210526 C14.0409862,12.4210526 13.4736842,12.9883546 13.4736842,13.6842105 C13.4736842,14.3798815 14.0409862,14.9473684 14.7368421,14.9473684 C15.4325131,14.9473684 16,14.3798815 16,13.6842105 C16,12.9883546 15.432698,12.4210526 14.7368421,12.4210526 L14.7368421,12.4210526 Z"
                        id="Path" fill="#000000"></path>
                    </g>
                  </g>
                </svg>Reddit</a>
              <a href="#"><svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  <title>1B6A0323-CDEF-4A8B-A537-D933BF9F2BD6</title>
                  <desc>Created with sketchtool.</desc>
                  <g id="Page-3" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                      ...
                      <g id="Group-5" transform="translate(80.000000, 339.000000)">
                        <g id="Stacked-Group-3" transform="translate(124.000000, 68.000000)">
                          <g id="flickr" transform="translate(96.000000, 0.000000)">
                            <path
                              d="M11.9152566,23.8283894 C18.4942301,23.8283894 23.8292389,18.4942301 23.8292389,11.9141947 C23.8292389,5.33479646 18.4942301,0.000637168142 11.9152566,0.000637168142 C5.33437168,0.000637168142 0,5.33500885 0,11.9141947 C0,18.4942301 5.33437168,23.8283894 11.9152566,23.8283894"
                              id="Path" fill="#000000"></path>
                            <g id="Group" transform="translate(5.734513, 9.132743)" fill="#F1F2F2">
                              <path
                                d="M12.1584425,2.78145133 C12.1584425,4.23610619 10.9803186,5.41529204 9.52566372,5.41529204 C8.06888496,5.41529204 6.89076106,4.23589381 6.89076106,2.78145133 C6.89076106,1.32722124 8.06888496,0.147823009 9.52566372,0.147823009 C10.9803186,0.147823009 12.1584425,1.32743363 12.1584425,2.78145133 Z"
                                id="Path"></path>
                              <path
                                d="M5.46881416,2.78145133 C5.46881416,4.23610619 4.29069027,5.41529204 2.8339115,5.41529204 C1.37968142,5.41529204 0.201557522,4.23589381 0.201557522,2.78145133 C0.201557522,1.32722124 1.37968142,0.147823009 2.8339115,0.147823009 C4.29069027,0.147823009 5.46881416,1.32743363 5.46881416,2.78145133 Z"
                                id="Path"></path>
                            </g>
                          </g>
                        </g>
              ...
              <a href="#"><svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  <title>19DAE029-7878-46AD-AFAE-A2AC5EAF0AD7</title>
                  <desc>Created with sketchtool.</desc>
                  <g id="Page-3" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <div class="tab-pane" id="visibility">
          <label class="radio-checkbox-container">Public(Published on your public gallery page)
            <input type="radio" id="is_active" name="is_active">
            <span class="checkmark"></span>
          </label>
          <label class="radio-checkbox-container" style="margin-top: 50px;">Private(Not published on your public gallery page)
            <input type="radio" id="isnt_active" name="is_active">
            <span class="checkmark"></span>
          </label>
          <a onclick="editImg('is_active')" style=" position: absolute;right: 0px;top: 464px;" class="artigram-btn blue-bg">Update</a>
        </div>
        ...
        <div class="tab-pane" id="settings">
          <div class="form-group">
            <h6 class="epsilon text-weight--bold">Danger zone</h6>
            <p>When a photo is deleted from Ondema, we will do everything we can to prevent its further distribution, including preventing it from being viewed and downloaded through Ondema. However, the
              <a href="/image-usage-rights" target="_blank">Ondema License</a> is irrevocable, so copies of the photo that were downloaded before deletion may still be used.</p>
            <a class="btn-link text-danger _37zTg _1l4Hh _1CBrG _1zIyn xLon9 _9G5GK NDx0k _2Xklx" data-confirm="Are you sure you want to delete this photo?" data-disable-with="···" rel="nofollow" data-method="delete" onclick="deleteImg()">Delete
              photo</a>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    update() {
      ...
      var that = this;
      axios.post('/api/update-img', formData)
        .then(response => {
          that.$toast.success({
          ...
          // window.location.href = this.$root.currentUrl + 'account';
        });
    },
    deleteImg() {
      this.$ma.trackEvent({
      ...
      var that = this;
      axios.get('/api/delete-img/'+this.img.id)
        .then(response => {
